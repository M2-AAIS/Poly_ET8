...
\begin{figure}[!ht]
    ...
    \end{subfigure}
    \begin{subfigure}[t]{.495\textwidth}
          \includegraphics[width=\textwidth]{H0323bl2_2.png}
    \end{subfigure}
    %\label{fig:}
    \caption{
...
\begin{figure}[!ht]
  \begin{subfigure}[t]{0.495\textwidth}
    \includegraphics[width=\textwidth]{HH30.jpg}
  \end{subfigure}
  \begin{subfigure}[t]{0.495\textwidth}
    \includegraphics[width=\textwidth]{HH34_in_orion.jpg}
  \end{subfigure}
\end{figure}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{HH34_optical_1.jpg}
  % \includegraphics[width=\textwidth]{HH34_optical_2.jpg}
  % \includegraphics[width=\textwidth]{HH34_optical_3.jpg}
  % \includegraphics[width=\textwidth]{HH34_optical_4.jpg}
  % \includegraphics[width=\textwidth]{HH34_optical_5.jpg}
  \caption{HH 34 optical jet (HST)}
\end{figure}
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{PRC95_24a.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{birth_death_MW.jpg}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[]{spectral_distribution.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{proper_motion.jpg}
  \caption{\label{fig:proper_motion} Proper motion seen in the HH 34 optical jet (HST). Credit: NASA/ESA/P. Hartigan (Rice University).}
\end{figure}
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{3c279_mosaic_hi.jpg}
  \caption{\label{fig:iras17596+4221} Quasar IRAS 17596+4221. Example of super luminal motions 3C279. Image courtesy of NRAO/AUI.}
\end{figure}
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{3C111.jpg}
  \caption{\label{fig:3C111} The image contains a series of radio images at successive epochs using the VLBA of the jet in the broad-line radio galaxy 3C 111. Credit: M. Kadler, E. Ros, M. Perucho, Y. Y. Kovalev, D. C. Homan, I. Agudo, K. I. Kellermann, M. F. Aller, H. D. Aller, M. L. Lister, and J. A. Zensus.}
\end{figure}
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{GRS1915.jpg}
  \caption{\label{fig:GRS1915} This image shows a pair of objects ejected from GRS 1915+105 moving apart at an apparently superluminal speed. Credit: Felix Mirabe, Saclay, France, and Luis Rodriguez, the National Autonomous University, Mexico City.}
\end{figure}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\textwidth]{rotation_clusters.png}
  \caption{From \cite{Aigrain2013}.}
\end{figure}
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{rotation_age.png}
  \caption{\label{fig:rotation_age} Figure from \cite{Gallet2013}.}
\end{figure}

These results can be compared to \cite{2008sf2a.conf..391B} results hereafter, showing plots of the
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{rotation_bouvier.png}
  \caption{\label{fig:rotation_bouvier}
    Rotational models for slow and fast solar-mass rotators.
    Data : The 10th and 75th percentiles of the observed
    rotational period distributions of solar-type stars (\SIrange{0.8}{1.1}{Msun})
    were converted to angular velocity and are plotted as
    direct and inverted triangles as a function of time. Individ
    ual measurements of rotational periods converted to angular
    velocities are also shown in order to illustrate the statistical
    significance of the various samples. Models :
    Rotational evolution models are shown for slow and fast \SI{1}{Msun}
    rotators. For each model in the upper panel, surface rotation is
    shown as a solid line, and the rotation of the radiative core by
    a dashed line. With a core-envelope coupling timescale $\tau_c$
    of only 10 Myr, little differential rotation develops in fast
    rotators. In contrast, the \SI{100}{Myr} core-envelope coupling
    timescale in slow rotators results in a large velocity gradient
    at the base of the convective zone. A disk lifetime of \SI{5}{Myr}
    is assumed for both models. Lower panels :
    The velocity shear at the base of the convective zone
    $(\omega_\textrm{rad} - \omega_\mathrm{conv})/w_\mathrm{conv}$,
    and the angular momentum transport rate $\Delta J/\tau_c$
    (\si{\g\cm\squared\per\s\squared})
    from the core to the envelope are shown for slow (solid
    line) and fast (dotted-dashed line) rotators. (from \cite{2008sf2a.conf..391B})}
\end{figure}
...
The set of solutions of the previous equation is displayed on the two following \FIXME{two figures?!}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.5\textwidth]{1991_eclipse.jpg}
  \caption{\label{fig:1991_eclipse} Image of the solar corona and the solar wind during the 1991 eclispe (Albers et al. Boulder).}
\end{figure}
\FIXME{missing scheme}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{YSO_IR.jpg}
\end{figure}
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{NGC_4261.jpg}
  \caption{This is a Hubble Space Telescope image of an 800-light-year-wide spiral-shaped disk of dust fueling a massive black hole in the centreof galaxy, NGC 4261, located 100 million light-years away in the direction of the constellation Virgo.. L. Ferrarese (Johns Hopkins University) and NASA/ESA}
\end{figure}
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{HH30.jpg}
\end{figure}
...
In advection dominated disk close to the central object, we should have a quite
high accretion rate $\dot{M} \approx \dot{M}_\mathrm{Edd}$:
\begin{align*}
    c_s^2 &= \frac{3 G M \dot{M} \tau}{8 \pi R^3 \rho c} \left(1 - \left(\frac{R_\mathrm{in}}{R}\right)^{\nicefrac{1}{2}}\right)
        \Rightarrow H = \frac{3 \dot{M} \sigma_\mathrm{T}}{8 \pi m_\mathrm{H} c} \left(1 - \left(\frac{R_\mathrm{in}}{R}\right)^{\nicefrac{1}{2}}\right) \\
    H &= \frac{3}{3} \frac{\dot{M} c^2}{L_\mathrm{Edd}} \frac{G M}{c^2} \left(1 - \left(\frac{R_\mathrm{in}}{R}\right)^{\nicefrac{1}{2}}\right)
\end{align*}

Thus the scale height is given by:
\begin{equation}
    \tcboxmath{
        \frac{H}{R} \approx \frac{3}{4} \frac{1}{\varepsilon} \frac{R_\mathrm{G}}{R} \left(1 - \left(\frac{R_\mathrm{in}}{R}\right)^{\nicefrac{1}{2}}\right)
        \xrightarrow[\varepsilon \ll 1, L \approx L_\mathrm{Edd}]{} \approx 1
    }
\end{equation}

Thus close to the central object, the thin disk approximation breaks and the
disk should become thick. This justifies the existence of various Geometrically
Thick disks:
\begin{itemize}
    \item ADAF, advection dominated accretion flow. In these models the opacity
          is low and subEddington. In this case the luminosity is not very
          different from the standard disk.
    \item Slim disk have a super-Eddington luminosity and low radiation :
          \begin{itemize}
              \item For thin disks, there is:
                    \begin{itemize}
                        \item Keplerian rotation,
                        \item The disk terminates at the inner stable orbit,
                              ISCO (if the central object is a black hole),
                        \item All locally released energy is radiated away.
                    \end{itemize}
              \item For slim disks, there is:
                    \begin{itemize}
                        \item Super-Keplerian rotation in the innermost part of
                              the disk, otherwise sub-Keplerian,
                        \item Inner disk edge can be closer than the ISCO (for
                              higher accretion rates),
                        \item A part of the dissipated energy is captured in
                              the flow and advected inwards.
                    \end{itemize}
          \end{itemize}
    \item In Inflow-Outflow structure (ADIOS, Advection Dominated In and
          Out-Flow), the outflow replaces the radiation.
\end{itemize}

\FIXME{Three figures missing}

\subsection{Magnetized Accretion disks}

In a MHD structure, the momentum conservation gives a steady state,
\begin{equation*}
    \vv{\nabla} \cdot \left(
        \rho \vv{v} \otimes \vv{v} +
        \left( p + \frac{B^2}{2 \mu_0} + \varepsilon_0 \frac{E^2}{2} \right) \overleftrightarrow{I} -
        \varepsilon_0 \vv{E} \otimes \vv{E} -
        \frac{1}{\mu_0} \vv{B} \otimes \vv{B} -
        \overleftrightarrow{T}_\mathrm{visc}
    \right) = \rho \vv{g}
\end{equation*}

In cold plasma (no radiation, heat flux, heating or enthalpy), where the
rotation speed is $V_\phi = \varpi \Omega$, it gives in the azimuthal direction
the conservation law of angular momentum,
\begin{equation}
    \tcboxmath{
        \vv{\nabla} \cdot \left(
            \rho \varpi^2 \Omega \vv{V_\mathrm{P}} -
            \varpi \overleftrightarrow{T}_\mathrm{visc} \cdot \vv{e_\phi} +
            \frac{\varpi B_\phi \vv{B_\mathrm{P}}}{\mu_0}
        \right) = 0
    }
\end{equation}

This is very comparable to the equations of conservation of angular momentum
given in next chapter. However, here the specific angular momentum flux is not
conserved as there is a transfer to the disk via the viscous torque. The
magnetic field can extract angular momentum if the magnetic torque reverses,
\begin{equation}
    \tcboxmath{
        \left( \vv{J} \times \vv{B} \right) \bullet \vv{B_\mathrm{P}} = - \left( \vv{J} \times \vv{B} \right) \bullet \vv{B_\phi}
    }
\end{equation}
\FIXME{Not sure about the use of \textbackslash{bullet} here, maybe it’s just \textbackslash{otimes}}
...
\FIXME{Equation references + alignment}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.5\columnwidth]{figures/DG-tau-B.jpg}
  \caption{\label{fig:DG-tau-B}Image of DG Tau B (see \url{http://www.spacetelescope.org/images/opo9905h/})}
\end{figure}
\fxnote{Missing figure}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.5\columnwidth]{figures/protoplanetary_disks_orion.jpg}
  \caption{\label{fig:proto_orion} Protoplanetary disks in Orion Nebula (see \url{http://www.spacetelescope.org/images/opo0113a/})}
\end{figure}

\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.5\columnwidth]{figures/YSO_IR.jpg}
  \caption{\label{fig:YSO_IR} Young stellar disks in infrared (see \url{http://sci.esa.int/hubble/17171-nicmos-peers-through-dust-to-reveal-young-stellar-disks/})}
\end{figure}
...
\fxnote{Missing figures}
\FIXME{Use the reference \cite{Zanni2013}}
