...
\begin{figure}[!ht]
    ...
    \begin{minipage}{.4\textwidth}
        ...
        Imager (WFI) on the MPG/ESO \SI{2.2}{\m} telescope located at La Silla,
        Chile, show the stars and the galaxy’s characteristic dust lane in
...
vanishes for $r=r_c$ and the l.h.s. for $v=v_s$ except if the flow has reached
...
value for a monoatomic gas, this means that the exists only because there is
