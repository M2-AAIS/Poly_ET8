...
\begin{equation}
  \dot{J}_\star = \frac{2}{3}\varepsilon_A^2\Omega \dot{M}_\mathrm{wind}
\end{equation}
...
\begin{equation}
  \tau \approx \frac{J_\star}{\dot{J}_\star} \approx \frac{3kr^2_\star \Omega M_\star}{2\varepsilon_A^2\Omega\dot{M}_\mathrm{wind}}
\end{equation}
