...
\begin{center}
    {\LatinModern M\textsubscript{\NotoSans ☺}} % C’est ironique, non ? – Un peu oui !
\end{center}
...
Clouds are clumps resulting from the Parker \FIXME{Jeans?} instability in the Milky Way. They
...
Bouvier et al. (\FIXME{Make a ref of that} results hereafter, showing plots of the evolution of
...
(\cite{2013ApJ...774L..21M} \FIXME{check ref}). In the same paper,
